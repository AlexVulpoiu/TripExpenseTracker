...
public class RemovedFromSpendingNotification extends BaseNotification {

    User from;
    User to;
    Spending spending;

    public RemovedFromSpendingNotification(User from, User to, Spending spending) {
        this.from = from;
        this.to = to;
    ...
    public NotificationDto getNotificationDto() {
        return NotificationDto.builder()
                ...
                .message(String.format("You have been removed from spending with ID #%d", spending.getId()))
